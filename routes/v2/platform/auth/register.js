...
const { db, generateToken, createPlatformRefreshToken } = require("../../../../lib/v2/auth");
...
module.exports = async function (fastify) {
  fastify.post("/auth/register", {
    ...
    schema: { body: bodySchema.platformRegister },
  }, async (req, reply) => {
    ...
    if (existing.rows[0]) {
      return apiError(reply, "AUTH_007");
    }
    ...
    try {
      ...
      req.log.error({ step: "platform_register", error: err.message });
