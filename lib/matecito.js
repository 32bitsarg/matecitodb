...
async function requireAdmin(req, reply) {
  // Primero verificar JWT de plataforma
  await requirePlatformAuth(req, reply);
  if (reply.sent) return; // requirePlatformAuth ya respondió 401

  // Luego verificar is_admin en DB (no en JWT — para que sea revocable)
